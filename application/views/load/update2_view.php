...
//                                            $date_formated = $date_formated_temp[1] . '/' . $date_formated_temp[0] . '/' . $date_formated_temp[2];
                        ...
                        echo'<td colspan="5" style="background-color: #EBEBEB; font-size: 14px;font-weight: bolder;">BOL #<span class="txt-bol-number">' . $row['bol_number'] . '</span><span class="del-shipment" data-shp_num="' . $i . '">X</span></td>';
                        echo'</tr>';
                        ...
                        echo'<tr class="shp_' . $i . '">';
                        echo'<td><input type="hidden" name="shp_db_id_' . $i . '" id="shp_db_id_' . $i . '" value="' . $row['idshipment'] . '"><input type="hidden" name="type_' . $i . '" id="type_' . $i . '" value="1">';
                        ...
                        echo'</select>';
                        echo'</td>';
                        echo'<td><input type="text" id="pk_' . $i . '" name="pickup" readonly="readonly" style="width:220px" value="' . $row['pickup_address'] . '"/><button type="button" class="btn btn-red btn-small" data-shp_id="' . $i . '" hidefocus="true" style="outline: medium none; margin: 0px 5px;" data-toggle="modal" data-target="#originAddressModal" id="set-model-pickup"><span class="gradient">+</span></button></td>';
                        echo'<td>';
                        echo'<input type="text" id="pk_number_' . $i . '" name="pickup_number" value="' . $row['pickup_number'] . '" style="width:50px;"/>';
                        echo'<input type="hidden" name="pk_zipcode_' . $i . '" id="pk_zipcode_' . $i . '" value="' . $row['pickup_zipcode'] . '">';
                        echo'<input type="hidden" name="pk_lat_' . $i . '" id="pk_lat_' . $i . '" value="' . $row['pickup_lat'] . '">';
                        echo'<input type="hidden" name="pk_lng_' . $i . '" id="pk_lng_' . $i . '" value="' . $row['pickup_lng'] . '">';
                        echo'</td>';
                        echo'<td><input type="text" id="dp_' . $i . '" name="drop" readonly="readonly" value="' . $row['drop_address'] . '"  style="width:220px"><button type="button" class="btn btn-red btn-small" data-shp_id="' . $i . '" hidefocus="true" style="outline: medium none;margin: 0px 5px;" data-toggle="modal" data-target="#destinationAddressModal" id="set-model-drop"><span class="gradient">+</span></button></td>';
                        echo'<td>';
                        echo'<input type="text" id="dp_number_' . $i . '" name="drop_number"value="' . $row['drop_number'] . '" style="width:50px;"/>';
                        echo'<input type="hidden" name="dp_zipcode_' . $i . '" id="dp_zipcode_' . $i . '" value="' . $row['drop_zipcode'] . '">';
                        echo'<input type="hidden" name="dp_lat_' . $i . '" id="dp_lat_' . $i . '" value="' . $row['drop_lat'] . '">';
                        echo'<input type="hidden" name="dp_lng_' . $i . '" id="dp_lng_' . $i . '" value="' . $row['drop_lng'] . '">';
                        echo'<input type="hidden" name="dp_lng_' . $i . '" id="bol_num_' . $i . '" class="bol-num" value="' . $row['bol_number'] . '">';
                        echo'</td>';
                        echo'</tr>';
                        echo'<tr class="shp_' . $i . '">';
                        echo'<td colspan="2">BOL #: <input type="text" id="bn_' . $i . '" class="bol-number" name="bol_number" value="' . $row['bol_number'] . '"/></td>';
                        echo'<td colspan="3" style="text-align: center;"><div id="shp_file_' . $i . '"><a href="../../../tkgo_files2/' . $row['url_bol'] . '" target="_blank">BOL</a> <a href="" data-id="' . $row['idshipment'] . '" data-shp_id="' . $i . '" class="remove_file">Delete</a></div><input type="hidden" id="shp_file_sw_' . $i . '" value="0"></td>';
                        echo'</tr>';
                        ...
                        echo'</span>';
                        echo'<a href="#" title="Set Shipment Contacts" id="shp_contact_chg_' . $i . '" data-ship="' . $i . '" class="pop" data-placement="right" data-content="Content" data-id_customer="' . $i . '">Change</a>';
...
//            icon: 'map-marker-driver.png',
                        ...
                        function setShipmentData(shp_number) {
                            ...
                            //Shipment number     
                            tRowSpace = $('<tr class="shp_' + shp_number + '">');
                            space = $('<td colspan = "6" style="background-color: #EBEBEB; font-size: 14px;font-weight: bolder;">').html('BOL #<span class="txt-bol-number"></span><span class="del-shipment" data-shp_num="' + shp_number + '">X</span><type="hidden" name="type_' + shp_number + '" id="type_' + shp_number + '" value="0">');
                            tRowSpace.append(space);
                            $('#bol-table tbody').append(tRowSpace);
                            ...
                            drop = $('<td>').html('<input type="text" id="dp_' + shp_number + '" name="drop" style="width:220px"/><button type="button" class="btn btn-red btn-small" data-shp_id="' + shp_number + '" hidefocus="true" style="outline: medium none;margin: 0px 5px;" data-toggle="modal" data-target="#destinationAddressModal" id="set-model-drop"><span class="gradient">+</span></button>');
                        ...
                        function getShipmentData() {
                            ...
                            $('#bol-table tbody tr').each(function () {
                                ...
                                if (tr.find('select').val() != null) {
                                    shipments.push({
                                        index: j,
                                        shipment_id: tr.find('#shp_db_id_' + j).val(),
                                        type: tr.find('#type_' + j).val(),
