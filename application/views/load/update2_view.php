...
//                                            $date_formated = $date_formated_temp[1] . '/' . $date_formated_temp[0] . '/' . $date_formated_temp[2];
                        ...
                        echo'</td>';
                        echo'<td><input type="text" class="dp" id="dp_' . $i . '" name="drop" readonly="readonly" value="' . $row['drop_address'] . '"  style="width:220px"><button type="button" class="btn btn-red btn-small" data-shp_id="' . $i . '" hidefocus="true" style="outline: medium none;margin: 0px 5px;" data-toggle="modal" data-target="#destinationAddressModal" id="set-model-drop"><span class="gradient">+</span></button></td>';
                        echo'<td>';
