...
//                                            $date_formated = $date_formated_temp[1] . '/' . $date_formated_temp[0] . '/' . $date_formated_temp[2];
                        ...
                        echo'<td colspan="5" style="background-color: #EBEBEB; font-size: 14px;font-weight: bolder;">BOL #<span class="txt-bol-number">' . $row['bol_number'] . '</span></td>';
                        echo'</tr>';
                        ...
                        echo'</td>';
                        echo'<td><input type="text" id="dp_1" name="drop" readonly="readonly" style="width:242px"><button type="button" class="btn btn-red btn-small" data-shp_id="1" hidefocus="true" style="outline: medium none;margin: 0px 5px;" data-toggle="modal" data-target="#destinationAddressModal" id="set-model-drop"><span class="gradient">+</span></button></td>';
                        echo'</tr>';
